    ...
    return (
        <section className="text-lightText font-poppins">
            <div className="container flex justify-center">
                <div id="animate-bottom" className=" flex justify-between bg-blue-500 bg-opacity-20 backdrop-blur-md lg:max-w-[80%] w-full rounded-lg p-[80px] relative">
            ...
            <div className="bg-backgroundThird mt-[-137.5px]">
                <div className="container pt-[300px] pb-[150px]">
                    ...
                    <div id="animate-bottom" className="flex bg-backgroundBox rounded-lg max-w-full">
