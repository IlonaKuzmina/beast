...
export const BestDealsSection = () => {
    return (
        <section className="pt-[150px] pb-[150px] text-lightText">
            <div className="container">
                <h2 id="animate-left" className="mb-[60px] text-[45px] font-bold text-center">Best deals</h2>
                <table id="animate-bottom" className="border-none rounded-xl w-full text-lg text-left rtl:text-right text-lightText">
