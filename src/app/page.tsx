...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-start bg-customBackground">
        <header className="flex justify-between items-center w-full pt-[40px] pb-[40px] px-[200px] shadow-bottom shadow-md text-lightText">
            <a href="/#">
                <div class="text-logo font-bold">CryptoBeast</div>
            </a>
